...
def extractor_get_common_follower(target_list, proxies=None, page_count=1):
    ...
    # url = 'https://tweepdiff.com/BillGates.followers/Oprah.followers/?n=100'
    author_list = []
    status = '0'
    try:
        # requests 重试机制
    ...
    result = {"status": status, "agent_type": "twitter", "fetch_type": "get_common_follower", "target_profile": target_profile,
