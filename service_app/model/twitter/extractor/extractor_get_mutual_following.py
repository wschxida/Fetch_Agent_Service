...
def extractor_get_mutual_following(target_list, proxies=None, page_count=1, html_code='0'):
    ...
    result = {"status": status, "agent_type": "twitter", "fetch_type": "get_mutual_following", "target_profile": target_profile,
...
def main():
    ...
    result = extractor_get_mutual_following(target_list, proxies)
    print(result)
